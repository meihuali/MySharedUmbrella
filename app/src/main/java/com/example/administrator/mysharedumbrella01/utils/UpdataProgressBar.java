 ...
 * </br>
 */
public class UpdataProgressBar extends View implements Runnable{
    ...
    public UpdataProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UpdataProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPgBimap() {
        int w = getMeasuredWidth() - borderWidth;
        int h = getMeasuredHeight() - borderWidth;
        pgBitmap = Bitmap.createBitmap(w, h, Bitmap.Config.ARGB_8888);
